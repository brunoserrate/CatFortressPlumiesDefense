...
onready var crystal_hp_bar = $CrystalHpBar
...
func _ready():
	...
	crystal_hp_bar.value = health
	crystal_hp_bar.max_value = health
...
func connectToSummonEvents():
	...
	var summonBtns = scene.get_node("UI/SummonBtns")
